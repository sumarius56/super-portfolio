...
function About({ pageInfo }: Props) {
  return (
    <motion.div
      ...
      className="flex  space-y-1 text-sm flex-col relative h-screen text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center"
    >
      ...
      >
        ...
        <p className="md:text-base text-sm leading-3 tracking-widest">
